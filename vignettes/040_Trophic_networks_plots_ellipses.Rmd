...
```{r plot network with ellipses per species, no points}
...
blank_data <- data.frame(Pond_code = c("U01", "U01", 
                                   "U02", "U02", 
                                   "U03", "U03",
                                   "U04", "U04",
                                   "U05", "U05",
...
blank_data$Pond_code <- factor(blank_data$Pond_code, 
                               levels = c("U01", "U02", "U03", "U04", "U05", "U06",
                                          "I01", "I02", #"I3", 
                                          "I04", "I05", "I06",
...
M_ind$Pond_code <- factor(M_ind$Pond, 
                               levels = c("U01", "U02", "U03", "U04", "U05", "U06",
                                          "I01", "I02", #"I3", 
                                          "I04", "I05", "I06",
                                          "I07", "I08", "I09", "I10", "I11", "I12",
...
CoordSEAc_pop$Pond_code <- factor(CoordSEAc_pop$Pond, 
                               levels = c("U01", "U02", "U03", "U04", "U05", "U06",
                                          "I01", "I02", #"I3", 
                                          "I04", "I05", "I06",
                                          "I07", "I08", "I09", "I10", "I11", "I12",
...
ellipses_pop <- ggplot(data = M_ind, aes(D13Ccor_consoI, TP)) +
  ...
  scale_color_manual(values = c("#E69F00", 
                                "#0072B2", "#009E73", 
                                "#56B4E9", "#CC79A7")) +
  facet_wrap(~Pond_name, scales = "free_x", 
             ncol = 3) +
  xlab(bquote(''*delta^13~C["cor"]*'')) +
  ylab("Trophic position") +
  guides(col = guide_legend("Species")) + 
...
## Figure with ellipses only
```{r plot ellipses per population only}
ellipses_pop <- ggplot() +
  theme_classic() +
  geom_path(data = CoordSEAc_pop, aes(coordX, coordY, col = Species), 
            size=2, linetype=1) +
