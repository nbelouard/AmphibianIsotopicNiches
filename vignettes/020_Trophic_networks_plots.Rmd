---
title: "Local isotopic niche partitioning and the coexistence between native amphibians and invasive crayfish #2: Network plots"
...
These plots show standardized trophic networks (TP and D13Ccor).
...
f <- ggplot(data = M_avg, aes(x = D13Cavg, y = TPavg)) +
  ...
  xlab(expression(paste('D'^{13},'C corrected and stardized' ))) + 
  ylab("TP")
