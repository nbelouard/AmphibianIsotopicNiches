...
Niche_metrics <- read.csv(file.path(here(), "data", 
                                    "Population_metrics_complete.csv"), h = T)
Mean_position <- read.csv(file.path(here(), 
                                    "data", 
                                    "Meanposition_SEAc_complete.csv"), header = T)
...
metrics_pivoted <- pivot_wider(metrics, names_from = TaxaUsed, 
